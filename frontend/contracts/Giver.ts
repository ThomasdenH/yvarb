...
export interface GiverInterface extends utils.Interface {
  functions: {
    "LOCK()": FunctionFragment;
    "LOCK8605463013()": FunctionFragment;
    "ROOT()": FunctionFragment;
    "ROOT4146650865()": FunctionFragment;
    "banIlk(bytes6,bool)": FunctionFragment;
    "bannedIlks(bytes6)": FunctionFragment;
    ...
    "seize(bytes12,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "banIlk",
    values: [PromiseOrValue<BytesLike>, PromiseOrValue<boolean>]
  ): string;
  encodeFunctionData(
    functionFragment: "bannedIlks",
  ...
  decodeFunctionResult(functionFragment: "banIlk", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "bannedIlks", data: BytesLike): Result;
  ...
  events: {
    "IlkBanned(bytes6)": EventFragment;
    "RoleAdminChanged(bytes4,bytes4)": EventFragment;
    "RoleGranted(bytes4,address,address)": EventFragment;
    "RoleRevoked(bytes4,address,address)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "IlkBanned"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "RoleAdminChanged"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "RoleGranted"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "RoleRevoked"): EventFragment;
}

export interface IlkBannedEventObject {
  ilkId: string;
}
export type IlkBannedEvent = TypedEvent<[string], IlkBannedEventObject>;

export type IlkBannedEventFilter = TypedEventFilter<IlkBannedEvent>;
...
export interface Giver extends BaseContract {
  ...
  filters: {
    "IlkBanned(bytes6)"(ilkId?: null): IlkBannedEventFilter;
    IlkBanned(ilkId?: null): IlkBannedEventFilter;
