...
export interface HelperContractInterface extends utils.Interface {
  functions: {
    ...
    "buyUsdc(uint256,address)": FunctionFragment;
    ...
    "grantYieldLeverAccess(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "grantYieldLeverAccess",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "buyUsdc", data: BytesLike): Result;
...
export interface HelperContract extends BaseContract {
  ...
  functions: {
    ...
    grantYieldLeverAccess(
      yieldLeverAddress: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    testBuyUsdc(overrides?: CallOverrides): Promise<void>;
